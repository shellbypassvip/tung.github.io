class Game {
  ...
  generateTweet() {
    ...
    window.open("https://facebook.com/lehonganhtung.info" + this.score + " points on Coloron! Can you beat my score?&amp;via=greghvns&amp;hashtags=coloron", "TweetWindow", "width=600px,height=300px,top=" + top + ",left=" + left);
  }
